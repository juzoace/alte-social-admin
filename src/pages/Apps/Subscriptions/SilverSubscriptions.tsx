...
const SilverSubscriptions = () => {
    const dispatch = useDispatch();
    useEffect(() => {
        dispatch(setPageTitle('Silver Subscriptions'));
    });
    ...
    useEffect(() => {
        //  In future Make Api call or dispatch action and set state to userList
...
export default SilverSubscriptions;
